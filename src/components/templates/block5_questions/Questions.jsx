...
return (
    <div className="containerQuestion">
        ...
        <div className="contaniner_question_cards">
            ...
            <CardQuestion tittle_question={"04. What does it mean to self-isolate?"}  />
            <CardQuestion tittle_question={"02. What are the symptomos of COVID-19?"} />
            <CardQuestion tittle_question={"05. Can childern or adolescents catch COVID-19?"} />
            <CardQuestion tittle_question={"03. Should I wear mask?"} />
